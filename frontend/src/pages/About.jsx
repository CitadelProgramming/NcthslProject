...
export default function About() {
  ...
  return (
    <div className="w-full text-gray-800 about-enhanced-section">
      ...
      {/* LEADERSHIP — NOW WITH SUBTLE INFINITE GLOW BORDER */}
      <section id="leadership" className="w-full">
        ...
        <div className="py-12 bg-gradient-to-br from-[#818589] to-[#525354] px-6">
          {leaders.length === 0 ? (
            ...
            <div className="max-w-7xl mx-auto flex gap-8 overflow-x-auto pb-6 snap-x snap-mandatory md:grid md:grid-cols-2 md:gap-12 md:overflow-visible lg:grid-cols-3">
              {leaders.map((leader, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="infinite-glow-border rounded-3xl">
                      <div className={`bg-gradient-to-br ${color} p-8 rounded-3xl shadow-2xl backdrop-blur-sm`}>
                        <div className="relative w-40 h-40 mx-auto mb-8 rounded-full overflow-hidden shadow-xl border-4 border-white/20">
                          <img
                            src={leader.photoUrl}
                            alt={leader.name}
                        ...
                        <p className="text-white/90 font-medium text-center mb-6">{leader.role}</p>
                        <p className="text-white/80 text-sm leading-relaxed text-center">
                          {leader.bio || "Dedicated leader in aviation excellence."}
                        </p>

                        <div className="mt-8 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-400 text-white font-semibold">
                          View Profile
